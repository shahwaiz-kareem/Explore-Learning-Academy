  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="bg-gradient-to-l px-8 from-blue-400 via-teal-400 to-green-300  py-2 bg-green-500 text-white font-bold rounded-md shadow-md hover:bg-green-600 transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
      >
